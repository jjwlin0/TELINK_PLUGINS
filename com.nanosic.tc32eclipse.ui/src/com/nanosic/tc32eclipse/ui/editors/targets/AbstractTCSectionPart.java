...
import com.nanosic.tc32eclipse.core.targets.ITargetConfigChangeListener;
import com.nanosic.tc32eclipse.core.targets.ITargetConfiguration;
import com.nanosic.tc32eclipse.core.targets.ITargetConfigurationWorkingCopy;
...
public abstract class AbstractTCSectionPart implements ITCEditorPart {
	...
	private class ChangeListener implements ITargetConfigChangeListener {
		...
		/*
		 * (non-Javadoc)
		 * @seecom.nanosic.tc32eclipse.core.targets.TargetConfiguration.ITargetConfigChangeListener#
		 * attributeChange(com.nanosic.tc32eclipse.core.targets.ITargetConfiguration, java.lang.String,
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.ui.editors.targets.ITCEditorPart#setParent(org.eclipse.swt.widgets.Composite
	 * )
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.ui.editors.targets.ITCEditorPart#setMessageManager(org.eclipse.ui.forms
	 * .IMessageManager)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.ui.editors.targets.ITCEditorPart#getControl()
	 */
