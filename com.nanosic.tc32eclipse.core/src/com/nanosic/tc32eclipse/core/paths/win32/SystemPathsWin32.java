...
package com.nanosic.tc32eclipse.core.paths.win32;
...
public class SystemPathsWin32 {
	...
	public static Location getMyService(String filter) {
	    BundleContext context = FrameworkUtil.getBundle(com.nanosic.tc32eclipse.TC32Plugin.class).getBundleContext();
