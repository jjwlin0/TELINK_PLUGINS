...
public enum PCDBProgrammers implements IProgrammer {
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IProgrammer#getId()
	 */
	public String getId() {
		return this.name();
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IProgrammer#getDescription()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IProgrammer#getAdditionalInfo()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IProgrammer#getHostInterfaces()
	 */
	public abstract HostInterface[] getHostInterfaces();

	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IProgrammer#getTargetInterface()
	 */
