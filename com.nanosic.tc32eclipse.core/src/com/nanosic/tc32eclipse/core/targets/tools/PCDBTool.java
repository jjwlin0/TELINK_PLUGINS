...
import com.nanosic.tc32eclipse.core.targets.IGDBServerTool;
import com.nanosic.tc32eclipse.core.targets.IProgrammer;
import com.nanosic.tc32eclipse.core.targets.IProgrammerTool;
import com.nanosic.tc32eclipse.core.targets.ITargetConfiguration;
import com.nanosic.tc32eclipse.core.targets.ITargetConfiguration.Result;
import com.nanosic.tc32eclipse.core.targets.ITargetConfiguration.ValidationResult;
import com.nanosic.tc32eclipse.core.tcdb.TCDBException;
import com.nanosic.tc32eclipse.core.toolinfo.ICommandOutputListener;
...
public class PCDBTool extends AbstractTool implements IProgrammerTool, IGDBServerTool {
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getId()
	 */
	public String getId() {
		return ID;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IAttributeProvider#getAttributes()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IAttributeProvider#getDefaultValue(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.core.targets.tools.AbstractTool#getCommand(com.nanosic.tc32eclipse.core.targets
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getVersion(com.nanosic.tc32eclipse.
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.tools.AbstractTool#getOutputListener()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getMCUs()
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getProgrammers(com.nanosic.tc32eclipse
	 * .core.targets.ITargetConfiguration)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getProgrammer(com.nanosic.tc32eclipse
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#validate(com.nanosic.tc32eclipse.core
	...
	/*
	 * (non-Javadoc)
	 * @see com.nanosic.tc32eclipse.core.targets.IGDBServerTool#isSimulator()
	 */
