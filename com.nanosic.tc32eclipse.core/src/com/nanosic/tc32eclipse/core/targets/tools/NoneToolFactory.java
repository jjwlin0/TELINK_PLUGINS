...
public class NoneToolFactory implements IToolFactory {
	...
	private class NoneTool implements IGDBServerTool, IProgrammerTool {
		 ...
		 * (non-Javadoc)
		 * @see
		 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#getMCUs(com.nanosic.tc32eclipse
		 * .core .targets.ITargetConfiguration)
		 */
		 ...
		 * (non-Javadoc)
		 * @see
		 * com.nanosic.tc32eclipse.core.targets.IAttributeProvider#getDefaultValue(java.lang.String)
		 */
		 ...
		 * (non-Javadoc)
		 * @see
		 * com.nanosic.tc32eclipse.core.targets.ITargetConfigurationTool#validate(com.nanosic.tc32eclipse
		 * .core .targets.ITargetConfiguration, java.lang.String)
		 */
