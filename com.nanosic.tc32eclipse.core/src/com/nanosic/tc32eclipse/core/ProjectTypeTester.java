 ...
 *     
 *******************************************************************************/
package com.nanosic.tc32eclipse.core;
 ...
 * &lt;enabledWhen&gt;
 * 	&lt;not&gt;
 * 		&lt;test property="com.nanosic.tc32eclipse.core.isStaticLib" /&gt;
 * 	&lt;/not&gt;
 * &lt;/enabledWhen&gt;
 * </pre>
 * 
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		...
		if (KEY_STATIC_LIB.equalsIgnoreCase(property)) {
			...
			if (p != null) {
				...
				if (prop != null) {
					...
					if (value.getId().equals("com.nanosic.tc32eclipse.buildArtefactType.staticLib")) {
						return true;
					}
				}
			}
		...
		if (KEY_APP.equalsIgnoreCase(property)) {
			...
			if (p != null) {
				...
				if (prop != null) {
					IBuildPropertyValue value = prop.getValue();
					if (value.getId().equals("com.nanosic.tc32eclipse.buildArtefactType.app")) {
						return true;
					}
				}
			}
