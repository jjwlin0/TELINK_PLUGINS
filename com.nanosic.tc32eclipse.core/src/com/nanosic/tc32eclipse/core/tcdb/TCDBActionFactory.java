 ...
 * Reference :   
 *******************************************************************************/
package com.nanosic.tc32eclipse.core.tcdb;
...
import com.nanosic.tc32eclipse.core.tcdb.TCDBAction.Action;
import com.nanosic.tc32eclipse.core.tcdb.TCDBAction.FileType;
import com.nanosic.tc32eclipse.core.tcdb.TCDBAction.MemType;
	...
	public static TCDBAction writeFlashAction(IConfiguration buildcfg) {
		...
		if (tools.length != 0) {
			...
			IOption outputoption = objcopy
					.getOptionBySuperClassId("com.nanosic.tc32clipse.objcopy.flash.option.output");
