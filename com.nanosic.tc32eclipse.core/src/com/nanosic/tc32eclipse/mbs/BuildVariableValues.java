 ...
 *******************************************************************************/
package com.nanosic.tc32eclipse.mbs;
...
//			IPathProvider TCDBpathprovider = new TC32PathProvider(TC32Path.TC32_PYTHON);
//			String Pythonpath = TCDBpathprovider.getPath().toOSString();
//			if (Pythonpath != null && !("".equals(Pythonpath))) {
//
//				return Pythonpath + File.separator;
//			}
//			return "";
//		}
//	},
